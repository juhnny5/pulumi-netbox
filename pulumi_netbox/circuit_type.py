...
__all__ = ['CircuitTypeArgs', 'CircuitType']

@pulumi.input_type
class CircuitTypeArgs:
...
class CircuitType(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CircuitTypeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CircuitTypeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CircuitTypeArgs.__new__(CircuitTypeArgs)

            __props__.__dict__["name"] = name
            __props__.__dict__["slug"] = slug
        super(CircuitType, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[str]] = None,
            slug: Optional[pulumi.Input[str]] = None) -> 'CircuitType':
        """
        ...
        __props__ = _CircuitTypeState.__new__(_CircuitTypeState)

        __props__.__dict__["name"] = name
        __props__.__dict__["slug"] = slug
        return CircuitType(resource_name, opts=opts, __props__=__props__)
